...
const whatifiDelete = "[ ⭐ | Star Bot | D4XG ]";
/** 
* @author NTKhang
	...
	onStart: async function ({ message, args, event, threadsData, getLang, role }) {
		...
		if (!command && !args[0] || !isNaN(args[0])) {
			...
			if (sortHelp == "name") {
				...
				await message.reply(getLang("help", msg, page, totalPage, commands.size, prefix, whatifiDelete));
			}
				...
				message.reply(getLang("help2", msg, commands.size, prefix, whatifiDelete));
			}
		}
