...
module.exports = {
	config: {
		name: "goodbye message ", // Name of command, it must be unique to identify with other commands
		version: "1.0", // Version of command
		author: "lil dera", // Author of command
		category: "greetings " // Category of command, it must be "events" to identify with other commands
	},
